    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Remplissez les informations de la facture. Le montant et la date de
            paiement seront complétés par l'administrateur.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="facture">
                Facture (PDF) <span className="text-red-500">*</span>
              </Label>
            ...
            {/* Informations complétées par l'admin */}
            <div className="p-3 bg-amber-50 border border-amber-200 rounded-md text-sm text-amber-700">
              La date de paiement et la référence de virement seront
              complétées par l'administrateur lors de la validation.
            </div>
