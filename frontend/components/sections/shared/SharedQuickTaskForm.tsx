// frontend/components/sections/shared/SharedQuickTaskForm.tsx
"use client";
...
export default function SharedQuickTaskForm({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div ref={popoverRef} className="w-full max-w-md bg-[#1c1c1f] border border-[#2a2a2e] rounded-xl shadow-xl">
        ...
        <form onSubmit={handleSubmit}>
          <div className="px-4 py-4 space-y-4">
            ...
            <div className="space-y-3 text-sm text-gray-400">
              {/* ASSIGNÉS - uniquement les membres de l'espace */}
              <div className="relative">
                ...
                {openField === "assignee" && (
                  <div className="absolute z-20 mt-2 bg-[#1f1f23] border border-gray-700 rounded-lg p-2 shadow-xl max-h-48 overflow-y-auto min-w-[200px]">
                    {loadingMembers ? (
                      <div className="text-center text-gray-400 text-xs">Chargement...</div>
                    ) : spaceMembers.length === 0 ? (
                      <div className="text-center text-gray-400 text-xs">Aucun membre dans cet espace</div>
                    ) : (
                        ...
                        return (
                          <button
                            ...
                            className={`w-full text-left px-2 py-1 rounded text-xs flex items-center gap-2 ${
                              selected ? "bg-purple-600 text-white" : "hover:bg-gray-700"
                            }`}
                          >
                            <span className="w-5 h-5 bg-purple-600 rounded-full flex items-center justify-center text-[10px]">
