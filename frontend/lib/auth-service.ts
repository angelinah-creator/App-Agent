...
export const authService = {
  ...
  async createClient(clientData: CreateClientDto) {
    const response = await api.post("/auth/clients", clientData);
    return response.data;
  },

  async completeClientProfile(profileData: any) {
    const response = await api.patch("/auth/clients/complete-profile", profileData);
    return response.data;
  },
